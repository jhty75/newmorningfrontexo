...
import hiddenArticles, { removeAllArticleFromStore } from '../reducers/hiddenArticles';
...
function Header() {
	...
	const handleRegister = () => {
		fetch('https://morningnewsbackexo.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morningnewsbackexo.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
	...
	const handleFaEyeClick = () => {
		dispatch(removeAllArticleFromStore())
	}
		...
		if (isModalVisible) {
			...
			userSection =
				<div className={styles.headerIcons}>
					...
					<FontAwesomeIcon onClick={() => handleFaEyeClick(hiddenArticles)}  icon={faEye} className={styles.bookmarkIcon}/>
				</div>
		}
	}
